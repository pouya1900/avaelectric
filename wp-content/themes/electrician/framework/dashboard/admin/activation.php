...
<div id="activetion" class="gt-tab-pane gt-is-active">
	<div class="feature-section two-col">
		<h2><?php esc_attr_e( 'Theme License Options', 'electrician' ); ?></h2>
					...
					if ( ! $license ) {
						...
						<tr valign="top" class="envato-liccence-button-tr">
							<th scope="row" valign="top">
								<?php esc_attr_e( 'Activate License', 'electrician' ); ?>
							</th>
							<td>
								<div class="envato_theme_theme_license_activate_envato_div">
									<input type="button" data-url="<?php echo esc_attr( $urlapihit ); ?>" class="envato_theme_theme_license_activate_envato" name="envato_theme_theme_license_activate" value="<?php esc_attr_e( 'Activate License Envato', 'electrician' ); ?>" />
								</div>
								<p><?php esc_html_e( 'If your theme license is activated another domain then you can remove license via below Manage Your License', 'electrician' ); ?></p>
								<a class="button button-large button-primary avada-large-button envato_theme_theme_license_manage" href="https://my.smartdatasoft.com/" target="_blank"><?php esc_html_e( 'Manage Your License', 'electrician' ); ?></a>
							</td>
						</tr>
					<?php } else { ?>
						<tr valign="top" class="envato-liccence-button-tr">
							<th scope="row" valign="top">
								<?php esc_attr_e( 'Deactivate License', 'electrician' ); ?>
							</th>
							<td>
								<div class="envato_theme_theme_license_deactivate_envato_div">
									<input type="button" data-url="<?php echo esc_attr( $urlapideactive ); ?>" class="envato_theme_theme_license_deactivate_envato" name="envato_theme_theme_license_deactivate" value="<?php esc_attr_e( 'Deactivate License Envato', 'electrician' ); ?>" />
								</div>
								<p><?php esc_html_e( 'If your theme license is activated another domain then you can remove license via below Manage Your License', 'electrician' ); ?></p>
								<a class="button button-large button-primary avada-large-button envato_theme_theme_license_manage" href="https://my.smartdatasoft.com/" target="_blank"><?php esc_html_e( 'Manage Your License', 'electrician' ); ?></a>
							</td>
