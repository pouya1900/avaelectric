<?php
/*
  Plugin Name: Electrician Demo Installer
...
require_once plugin_dir_path( __FILE__ ) . 'one-click-demo-import-setting.php';
/**
...
class OCDI_Plugin {
	...
	public function __construct() {
		...
		if ( version_compare( phpversion(), '5.3.2', '<' ) ) {
			...
			// Composer autoloader.
			include_once PT_OCDI_PATH . 'vendor/autoload.php';
