...
add_filter(
	'pt-ocdi/replace_url',
	function () {
		return array( 'https://smartdata.tonytemplates.com/electrician-v2/' );
	}
);
...
add_filter(
	...
	function () {
		return '/wp-content/plugins/electrician-demo-installer/images/';
	}
);
	...
	function() {
		return array(
			array(
				...
				'preview_url'                  => 'https://smartdata.tonytemplates.com/electrician-v2/',
